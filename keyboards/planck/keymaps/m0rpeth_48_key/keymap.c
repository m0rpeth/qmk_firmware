...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [LYR_QWERTY] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL, KC_LALT, QK_LEAD, KC_LGUI, LT_LWR, KC_SPC, KC_SPC, LT_RSE, RG_ENT, QK_LEAD, KC_RALT, KC_RCTL
    ),
    ...
    [LYR_LOWER] = LAYOUT_ortho_4x12(
        KC_NO, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_NO, KC_NO, KC_F9, KC_F10, KC_F11, KC_F12, KC_TRNS,
