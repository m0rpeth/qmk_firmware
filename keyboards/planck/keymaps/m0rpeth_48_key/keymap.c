...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [LYR_ALPHA] = LAYOUT_ortho_4x12(
        ...
        MO(LYR_FN), KC_LCTL, KC_LALT, KC_LGUI, LT(0,KC_LWR), KC_SPC, KC_SPC, LT(0,KC_RSE), KC_RGUI, KC_RALT, KC_RCTL, QK_LEAD
    ),
    [LYR_COLEMAK] = LAYOUT_ortho_4x12(
        KC_TRNS, KC_Q, KC_W, KC_F, KC_P, KC_G, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_TRNS,
        KC_TRNS, KC_A, KC_R, KC_S, LSFT_T(KC_T), KC_D, KC_H, RSFT_T(KC_N), KC_E, KC_I, KC_O, KC_QUOT,
    ...
    [LYR_LOWER] = LAYOUT_ortho_4x12(
        ...
        KC_NO, KC_EXLM, KC_AMPR, KC_LPRN, KC_RPRN, KC_GRV, KC_PIPE, KC_MINS, KC_EQL, KC_PLUS, KC_AT, KC_NO,
        KC_TRNS, KC_HASH, KC_DLR, KC_LCBR, KC_RCBR, KC_PERC, KC_BSLS, KC_LBRC, KC_RBRC, KC_ASTR, KC_UNDS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    [LYR_RAISE] = LAYOUT_ortho_4x12(
        KC_NO, KC_NO, KC_7, KC_8, KC_9, KC_NO, KC_NO, KC_HOME, KC_UP, KC_END, KC_PGUP, KC_DEL,
        KC_NO, KC_0, KC_4, KC_5, KC_6, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_NO,
        KC_TRNS, KC_NO, KC_1, KC_2, KC_3, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    ...
    [LYR_ADJUST] = LAYOUT_ortho_4x12(
        ...
        TG(LYR_COLEMAK), KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO
    )
};
