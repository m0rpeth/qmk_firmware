...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LYR_QWERTY] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL,    QK_LEAD,    KC_LALT,    KC_LGUI,    LT_NAV,    KC_SPC,    KC_SPC,    LT_SYM,    MT_ENT,     KC_RALT,    MO_FN,      KC_RCTL
    ),
    ...
    [LYR_ADJ] = LAYOUT_ortho_4x12(
        TG_CO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,      KC_NO,    KC_NO,    KC_NO,      KC_NO,       KC_NO,      KC_NO,      QK_BOOT,
