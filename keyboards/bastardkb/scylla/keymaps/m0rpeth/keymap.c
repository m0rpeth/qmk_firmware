...
//const uint16_t PROGMEM kc_ent_combo[] = {LT_RSFT, LT_RGUI, LT_RALT, COMBO_END};
//combo_t key_combos[] = {
//    COMBO(kc_ent_combo, KC_ENT)
//};
//
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LYR_NAV] = LAYOUT_split_4x6_5(
        KC_NO,      KC_TRNS, KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS,                KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS,    KC_NO,
        KC_TRNS,    KC_COMM, KC_7,      KC_8,       KC_9,       KC_DLR,                 KC_HOME,    KC_PGUP,    KC_PGDN,    KC_END,    KC_NO,      KC_NO,
